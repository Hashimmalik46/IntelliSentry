...
import { ArrowDownLeft, ArrowUpRight, History, Shield, CheckCircle2, Clock, Building, UserCheck, AlertCircle, Home, LogOut, FileText, ArrowRight, X } from 'lucide-react';
    ...
    <Layout headerRight={headerRight}>
      <div className="max-w-5xl mx-auto space-y-6 font-body">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h2 className="text-2xl font-bold text-gray-900 font-heading">Hostel Gate Verification & Movement</h2>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-4 py-2 bg-teal-50 hover:bg-teal-100 text-[#006a6a] text-xs font-bold rounded-xl border border-teal-200 shadow-xs transition-all flex items-center gap-2 cursor-pointer font-heading"
            >
              <FileText className="w-4 h-4" /> Leave Passes
            </button>
            <button
              onClick={() => navigate('/activity-logs')}
              className="px-4 py-2 bg-white hover:bg-gray-50 text-gray-700 text-xs font-bold rounded-xl border border-gray-200 shadow-xs transition-all flex items-center gap-2 cursor-pointer font-heading"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <span className="px-2 py-0.5 bg-amber-50 text-amber-700 text-[10px] font-bold rounded-full font-heading uppercase">
                  Normal Exit
                </span>
              </div>
              <div>
                <h3 className="text-base font-bold text-gray-900 font-heading">Normal Exit</h3>
                <p className="text-xs text-gray-500 font-body mt-0.5">Local campus outing during standard hours</p>
              </div>
            </button>
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <span className={`px-2 py-0.5 text-[10px] font-bold rounded-full font-heading uppercase ${approvedPass ? 'bg-purple-100 text-purple-800' : 'bg-gray-100 text-gray-500'}`}>
                  {approvedPass ? 'Pass Approved ✅' : 'Pass Required'}
                </span>
              </div>
              <div>
                <h3 className="text-base font-bold text-gray-900 font-heading">Exit to Home</h3>
                <p className="text-xs text-gray-500 font-body mt-0.5">Weekend / Home leave with approved leave pass</p>
              </div>
            </button>
